...
import { ASSETS, type AssetSymbol, type TxType, type WalletTx } from '@/lib/wallet/assets'
...
export function ActivityClient({ transactions }: { transactions: WalletTx[] }) {
