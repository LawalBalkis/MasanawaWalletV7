...
export default async function AdminFundingsPage() {
  await requireAdmin()
  const [fundings, stats] = await Promise.all([
  ...
  return (
    <div className="flex flex-col gap-6">
      <AdminHeader
        title="Fundings"
        description="Every bank deposit credited into a virtual account via the Billstack webhook. Unmatched rows had no user on file."
      />
