  ...
  return (
    <section className="border-b border-border bg-secondary">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-8 lg:px-12 lg:py-20">
        <div className="flex flex-col items-center justify-between gap-6 text-center lg:flex-row lg:items-end lg:text-left"><div className="max-w-2xl"><span className="font-mono text-xs uppercase tracking-[0.2em] text-primary">Balances that work together</span><h2 className="mt-5 text-balance text-3xl font-semibold tracking-tight text-foreground sm:text-4xl">Naira at the centre. Crypto within reach.</h2></div><p className="max-w-md text-sm leading-relaxed text-muted-foreground">Availability can vary by asset, network, account status, and market conditions.</p></div>
